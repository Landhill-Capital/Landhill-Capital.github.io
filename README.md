...
Landhill Capital is an agile investment company focused on micro-SaaS and AI startups. We are looking for a talented and motivated Investment Analyst to support market research, financial analysis, and due diligence for potential investments.
...
* Next.js
* Tailwind CSS
* Markdown for blog posts in the `posts` directory
* Dev Containers (`.devcontainer/devcontainer.json`) for a consistent and isolated development environment
...
## Contact Email: [fangzhangnz@gmail.com](mailto:fangzhangnz@gmail.com)